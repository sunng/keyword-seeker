...
import self.sunng.keyword.seeker.fragment.HTMLFragment;
import self.sunng.keyword.seeker.process.DataInit;
import self.sunng.keyword.seeker.process.Highlight;
import self.sunng.keyword.seeker.process.Processor;
import self.sunng.keyword.seeker.process.WordFinder;
...
public class KWSeeker {
    ...
    public boolean isContain(String text) {
        return new WordFinder().isContain(wordsTree, text, null, wordLeastLen);
    }
